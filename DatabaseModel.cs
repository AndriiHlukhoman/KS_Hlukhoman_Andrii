...
namespace PostgreConsoleInteractorCS
{
    public class DatabaseModel
    {
        ...
        public void Search()
        {
            ...
            Console.WriteLine("2 - select event by categoty_id");
            ...
            switch (search)
            {
                case 1:
                    ...
                    NpgsqlCommand command1 = new NpgsqlCommand("SELECT name FROM category WHERE department_id = " + venue_id, connection);
                ...
                case 2:
                    ...
                    NpgsqlCommand command2 = new NpgsqlCommand("SELECT name FROM event WHERE category_id = " + category_id, connection);
                ...
                case 3:
                    ...
                    NpgsqlCommand command3 = new NpgsqlCommand("SELECT name FROM department WHERE department_id = " + venue_id3, connection);
